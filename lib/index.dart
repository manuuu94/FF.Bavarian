...
export '/pages/inventario/detalles_producto/detalles_producto_widget.dart'
...
export '/pages/cotizaciones/cotizacion/cotizacion_widget.dart'
    show CotizacionWidget;
