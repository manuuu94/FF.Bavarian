...
class _IndexWidgetState extends State<IndexWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ImagenesRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<ImagenesRecord> stackImagenesRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final stackImagenesRecord = stackImagenesRecordList.isNotEmpty
              ? stackImagenesRecordList.first
              : null;
          return Stack(
            children: [
              Image.asset(
                                      ...
                                      Container(
                                        ...
                                        child: custom_widgets.Carrusel(
                                          ...
                                          height: MediaQuery.of(context)
                                                  ...
                                                  .height *
                                              0.2,
                                          imgList: stackImagenesRecord!.imgPath!
                                              .toList(),
                                        ),
                                      ),
                                    ],
